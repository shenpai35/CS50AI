...
def minimax(board):
    ...
    # Case of player is X (max-player)
        ...
        for action in actions(board):
            # Add in plays a tuple with the min_value and the action that results to its value
    ...
    # Case of player is O (min-player)
        ...
        # Loop over the possible actions
        for action in actions(board):
            # Add in plays a tuple with the max_value and the action that results to its value
